...
import { Route as RouteIcon, Target, LineChart, TrendingUp, Trophy, Sparkles } from "lucide-react";

export const Route = createFileRoute("/analyse")({
  head: () => ({
    meta: [
      { title: "Analyse — Neet Buddy" },
      { name: "description", content: "AI study path, score predictor, weekly progress, improvement areas and NEET leaderboard." },
      { property: "og:title", content: "Analyse — Neet Buddy" },
      { property: "og:description", content: "AI study path, score predictor, weekly progress, improvement areas and NEET leaderboard." },
